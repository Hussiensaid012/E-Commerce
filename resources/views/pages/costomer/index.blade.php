                                        ...
                                        @foreach ($costomers as $costomer)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="{{ route('costomer.edit', $costomer->id) }}"
                                                        class="btn btn-info btn-sm" title="Edit" role="button"
                                                        aria-pressed="true"><i class="fa fa-edit"></i></a>
                                                    <button type="button" class="btn btn-danger btn-sm"
                                                        data-toggle="modal"
                                                        data-target="#delete_book{{ $costomer->id }}" title="Delete"><i
                                                            class="fa fa-trash"></i></button>
                                                </td>
                                            </tr>

                                            {{-- @include('pages.library.destroy') --}}
                                            <div class="modal fade" id="delete_book{{ $costomer->id }}" tabindex="-1"
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form
                                                                action="{{ route('costomer.destroy', $costomer->id) }}"
                                                                method="post">
                                                                @csrf
                                                                @method('DELETE')
